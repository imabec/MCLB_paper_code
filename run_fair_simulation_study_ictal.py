...
OUTFILE = "fair_simulation_results_alpha_gamma_ictaly.csv"
SUMMARY_OUTFILE = "fair_simulation_summary_by_alpha_gamma_ictaly.csv"
DETECTION_OUTFILE = "fair_simulation_detection_summary_by_alpha_gamma_ictaly.csv"
...
GAMMA_VALUES = [-.55,-.3,1.45]
ALPHA_VALUES = [-5, -2.4, -.6]
PHI_VALUES = [0.58]
R_VALUES = [.048]
