...
OUTFILE = "fair_simulation_results_alpha_gamma_intercialy.csv"
SUMMARY_OUTFILE = "fair_simulation_summary_by_alpha_gamma_intery.csv"
DETECTION_OUTFILE = "fair_simulation_detection_summary_by_alpha_gamma_intery.csv"
...
GAMMA_VALUES = [-2.5,-.06,1.17]
ALPHA_VALUES = [-7.7, -4, -1.58]
PHI_VALUES = [0.22]
R_VALUES = [.004]
