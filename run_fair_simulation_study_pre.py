...
OUTFILE = "fair_simulation_results_alpha_gamma_pre.csv"
SUMMARY_OUTFILE = "fair_simulation_summary_by_alpha_gamma_pre.csv"
DETECTION_OUTFILE = "fair_simulation_detection_summary_by_alpha_gamma_pre.csv"
...
GAMMA_VALUES = [-3.5,-.03,1.45]
ALPHA_VALUES = [-7.98, -5.08, -2.52]
PHI_VALUES = [0.22]
R_VALUES = [.001]
